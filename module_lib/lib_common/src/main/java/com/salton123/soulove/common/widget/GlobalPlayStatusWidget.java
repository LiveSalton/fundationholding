...
public class GlobalPlayStatusWidget extends FrameLayout {
    ...
    public GlobalPlayStatusWidget(@NonNull Context context) {
        this(context, null);
    }

    public GlobalPlayStatusWidget(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GlobalPlayStatusWidget(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
