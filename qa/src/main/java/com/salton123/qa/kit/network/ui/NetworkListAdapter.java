 ...
 * @desc: 抓包列表页适配器
 */
public class NetworkListAdapter extends AbsRecyclerAdapter<AbsViewBinder<NetworkRecord>, NetworkRecord>
    ...
    private class ItemViewHolder extends AbsViewBinder<NetworkRecord> {
        ...
        public void bind(final NetworkRecord record) {
            ...
            flow.setText(String.format(FLOW_FORMAT, ByteUtil.getPrintSize(record.requestLength),
                    ByteUtil.getPrintSize(record.responseLength)));
