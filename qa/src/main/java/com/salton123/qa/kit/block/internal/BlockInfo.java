 ...
 */
package com.salton123.qa.kit.block.internal;
...
import com.salton123.qa.kit.block.BlockCanaryInternals;
...
public class BlockInfo {
    ...
    static {
        ...
        sQualifier = BlockCanaryInternals.config().provideQualifier();
        try {
    ...
    public static BlockInfo newInstance() {
        ...
        Context context = BlockCanaryInternals.config().provideContext();
    ...
    public BlockInfo setMainThreadTimeCost(long realTimeStart, long realTimeEnd, long threadTimeStart,
                                           long threadTimeEnd) {
