...
public class PageDataItemAdapter extends AbsRecyclerAdapter<AbsViewBinder<PageDataItem>, PageDataItem> {
    ...
    private void setValue(View iteView, PageDataItemChild data) {
        ...
        ((TextView) iteView.findViewById(R.id.high_data_txt))
                .setText(String.format(rule, getFormatText(data.nameResId, data.max)));
        ((TextView) iteView.findViewById(R.id.low_data_txt))
                .setText(String.format(rule, getFormatText(data.nameResId, data.min)));
        ((TextView) iteView.findViewById(R.id.avg_data_txt)).setText(
                String.format("%s - " + rule, mContext.getString(R.string.dk_frameinfo_avg_value),
                        getFormatText(data.nameResId, data.avg)));
    }
