...
import com.salton123.qa.kit.network.utils.CostTimeUtil;
import com.salton123.qa.ui.chart.BarChart;
import com.salton123.qa.ui.chart.PieChart;
...
public class NetWorkSummaryView extends LinearLayout {
    ...
    private void initView() {
        ...
        barChart.setData(postCount, getResources().getColor(R.color.dk_color_55A8FD), getCount,
                getResources().getColor(R.color.dk_color_FAD337));
    }
