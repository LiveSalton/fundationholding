...
public class ColorPickerFloatPage extends BaseFloatPage
        implements View.OnTouchListener, TouchProxy.OnTouchEventListener {
    ...
    protected void onCreate(Context context) {
        mTouchProxy = new TouchProxy(this);
        mInfoFloatPage =
                (ColorPickerInfoFloatPage) FloatPageManager.getInstance().getFloatPage(PageTag.PAGE_COLOR_PICKER_INFO);
    ...
    private void showInfo() {
        ...
        int startY =
                y + ColorPickConstants.PICK_VIEW_SIZE / 2 - pickAreaSize / 2 + UIUtils.getStatusBarHeight(getContext());
