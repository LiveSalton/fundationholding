...
public class AlignRulerInfoFloatPage extends BaseFloatPage
        implements TouchProxy.OnTouchEventListener, AlignRulerMarkerFloatPage.OnAlignRulerMarkerPositionChangeListener {
