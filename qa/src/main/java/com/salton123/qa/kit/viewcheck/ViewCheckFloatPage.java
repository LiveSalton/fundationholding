...
public class ViewCheckFloatPage extends BaseFloatPage implements TouchProxy.OnTouchEventListener {
    ...
    protected void onCreate(Context context) {
        ...
        mResumedActivity = ActivityUtils.getCurrentResumedActivity();
    ...
    private View traverseViews(View view, int x, int y) {
        ...
        if (view instanceof ViewGroup) {
            ...
            XLog.d(TAG, "class: " + view.getClass() + ", left: " + left
    ...
    public void onUp(int x, int y) {
        View selectView = findSelectView(getLayoutParams().x + getRootView().getWidth() / 2,
                getLayoutParams().y + getRootView().getHeight() / 2);
