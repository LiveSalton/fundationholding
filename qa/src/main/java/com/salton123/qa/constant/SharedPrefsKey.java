package com.salton123.qa.constant;
...
public interface SharedPrefsKey {
    ...
    String LOG_INFO_FLOAT_LAYOUT_POS_X = "log_info_float_layout_pos_x";
    String LOG_INFO_FLOAT_LAYOUT_POS_Y = "log_info_float_layout_pos_y";
}
