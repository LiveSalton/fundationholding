package com.salton123.qa.ui.frameinfo;
...
public class PolyLineItemView extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mGradientPaint == null) {
            ...
            mGradientPaint.setShader(
                    new LinearGradient(0, 0, viewWidth, viewHeight, getResources().getColor(R.color.dk_color_3300BFFF),
    ...
    private void drawGraph(Canvas canvas) {
        ...
        if (drawLeftLine) {
            ...
            float middleY =
                    ((pointBottomY - pointTopY) * 1f / (maxValue - minValue) * (maxValue - middleValue + minValue) +
                            pointTopY);
