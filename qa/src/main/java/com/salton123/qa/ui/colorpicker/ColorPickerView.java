package com.salton123.qa.ui.colorpicker;
...
public class ColorPickerView extends View {
    ...
    private void drawBitmap(Canvas canvas) {
        ...
        mBitmapMatrix.reset();
        mBitmapMatrix.postScale(getWidth() / (float) mCircleBitmap.getWidth(),
                getHeight() / (float) mCircleBitmap.getHeight());
    ...
    public void setBitmap(Bitmap bitmap, int color, int x, int y) {
        ...
        mText = String.format(ColorPickConstants.TEXT_FOCUS_INFO, ColorUtil.parseColorInt(color),
